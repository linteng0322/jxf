...
<script type="text/javascript">
	...
	function addElement(typenumber, materialId, thickness, color, length, materialcount) {
		...
		var	appendstring = 		"<tr><td>"
								...
								+ "</td><td>"
								+ "<input id='materialId_"+typenumber+"_"+i+ "' name='materialId_"+typenumber+"' value='"+materialId+"' list='json-datalist' style='padding: 4px; border: none; background: transparent;' readonly='readonly'"
							...
							<c:forEach var="additionalmaterial"
								...
								<tr>
									<td><input
										...
										style='padding: 4px; border: none; background: transparent;' /></td>
									<td><input
