      ...
      <div style="float:right;width:80%;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
		       <sf:form servletRelativeAction="save" method="post" modelAttribute="industry" cssClass="form-horizontal">
		            <sf:errors path="*" cssClass="alert alert-danger" element="div"/>
	                <sf:hidden path="id"/>
	                <div class="form-group">
				        <sf:label path="industrydesc" cssClass="col-sm-4 control-label">
				            <sp:message code="label.desc"/><span class="required">*</span>
				        </sf:label>
				         
				        <div class="col-sm-4">
				             <sf:input path="industrydesc" maxlength="20" cssClass="form-control"/>
				        </div>
				    </div>
				    
				    <div class="form-group">
				        <sf:label path="code" cssClass="col-sm-4 control-label">
				            <sp:message code="label.industry"/><span class="required">*</span>
				        </sf:label>
				         
				        <div class="col-sm-4">
				             <sf:input path="code" maxlength="20" cssClass="form-control"/>
				        </div>
				    </div>
