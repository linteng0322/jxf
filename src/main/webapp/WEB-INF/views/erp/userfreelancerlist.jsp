	 ...
	 <script type="text/javascript">
	   $(document).ready(function(){ 
	    ...
	    function searchfreelancer(){
	 	   ...
	 	   window.open('${pageContext.request.contextPath}/user/searchfreelanceruser','freelancer',popup_property);
	    }
	  </script>  
     ...
     <%@ include file="../includes/header.jsp"%> 
      ...
      <div style="float:right;width:80%;">
         ...
         <div class="operation-bar ">
		    <a href="<c:url value="/user/add?mode=F"/>" title="Add">
		        <span class="glyphicon glyphicon-plus"></span>
		    </a>
		     <a onclick="searchfreelancer()" >
				<span id="searchfreelancer" class="glyphicon glyphicon-search"></span>
			   </a> 
		</div>
			...
			<table class="table table-striped table-bordered table-hover table-condensed">
			    ...
			    <tr>
			       <th><sp:message code="label.id"/></th>
			        <th><sp:message code="label.freeno"/></th>
			    ...
			    <c:forEach var="user" items="${page.list}" varStatus="loop">
			        <tr>
			            ...
			            <td>
			            <a href="<c:url value="/user/userfreelancerinfo?userno=${user.userno}"/>">
			            ...
			            <td>
			                <a href="<c:url value="/bank/viewbankinfo?id=${user.id}"/>">
